...
class soft_buffer:
    def __init__(self, size, obs_dim, act_dim, gamma, lam, alpha=1):
        """
        ...
        :param alpha: trade-off factor between maximum reward or entropy
        """
    ...
    def finish_path(self, val):
        ...
        self.rew_buf[path_slice] *= self.alpha
        self.rew_buf[path_slice] -= self.logp_buf[path_slice]  # reward shaping to incorporate entropy

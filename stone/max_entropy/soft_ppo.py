...
class soft_ppo:
    def __init__(self, env_fn, hid=64, layers=2, gamma=0.99, lam=0.97, alpha=1., seed=0,
                 steps_per_epoch=4000, pi_lr=3e-4, v_lr=1e-3, clip_ratio=0.2, logger_kwargs=dict()):
        super(soft_ppo, self).__init__()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='soft_ppo')
    ...
    agent = soft_ppo(lambda: gym.make(args.env), hid=args.hid, layers=args.layers, seed=args.seed, lam=args.lam,
